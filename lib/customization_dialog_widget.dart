...
class _CustomizationDialogWidgetState extends State<CustomizationDialogWidget> {
  ...
  void _addToCart() {
    ...
    final data = {
      ...
      "rawCustomization": {
        "basePrice": basePrice,
        "selectedOptions": _selectedOptions.map((k, v) => MapEntry(k.toString(), v is Set ? v.toList() : v)),
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Base Price: ${basePrice.toStringAsFixed(2)} TL", style: const TextStyle(color: Colors.white70, fontSize: 12)),
                    ],
                  ),
                ),
              ],
                          ...
                          children: [
                            ...
                            if (isCheckbox && maxSel > 1) 
                              Padding(
                                ...
                                child: Text("You can select up to $maxSel options.", style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
                              ),
                            LayoutBuilder(
                                  ...
                                  children: options.asMap().entries.map((optEntry) {
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: isSelected ? widget.activeBgColor : Colors.white,
                                          border: Border.all(color: isSelected ? widget.primaryColor : Colors.grey.shade300, width: 1.5),
                                          ...
                                          children: [
                                            if (isSelected && !isCheckbox)
                                              Positioned(
                                                top: -6,
                                                right: -2,
                                                child: Icon(Icons.check_circle, color: widget.primaryColor, size: 16),
                                              ),
                                            Center(
                                              child: Column(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isValid ? widget.primaryColor : Colors.grey.shade400,
