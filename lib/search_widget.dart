                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(price, style: TextStyle(color: widget.primaryColor, fontWeight: FontWeight.bold, fontSize: 12)),
                        trailing: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text("Add", style: TextStyle(color: widget.darkColor, fontWeight: FontWeight.bold, fontSize: 11)),
                          ),
                        ),
                      );
                    },
